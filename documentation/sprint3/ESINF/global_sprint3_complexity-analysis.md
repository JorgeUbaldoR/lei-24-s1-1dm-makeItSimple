...
- **Complexity:** O(1)
- **Explanation:** This method adds a new vertex to the graph. Since adding a vertex to a graph generally involves inserting it into a data structure (e.g., a hash map or list), the operation is typically constant-time, O(1).
